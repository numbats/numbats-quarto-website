...
and students completing this degree are expected to be able to:
...
Students must complete 12 core units and 4 elective units. 
...
And **two of the four units** from the following list,
...
And **four elective units** from the following list, or others by special request. 
...
This unit presents data analysis, statistical modelling and decision-making in the presence of uncertainty, using a computational approach.  You will use different frameworks of probability that are useful for analysing real-world problems. Topics covered will include exploratory data analysis, simulation, permutation and randomisation methods, Bayesian analysis, decision theory, and model assessment and diagnosis.
...
This course involves successful completion of an internship or conduct an original research project.
