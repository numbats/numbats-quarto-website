...
We have a teaching philosophy to use fresh and local data, as defined in [these slides](https://wcd.numbat.space/week1/#/flavours-of-open-data). These resources can be found at [this website](data.html).
