...
<!-- topic list:
- basics of tidy data wrangling
- basic data visualisation with ggplot2
- making maps
- reproducible data analysis (quarto)
- collaborative data analysis (git)
- publishing your software
- packaging your software for sharing
- communicating your data with a web app
- finding and wrangling wild-caught data
- forecasting
...
- utilising LLMs in data analysis
- running computing intensive code simply on basic equipment
- working with text data
- making your research website
- web scraping
-->
